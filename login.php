            ...
            if (!$query) {
                ...
                if ($count == 1) {
                    ...
                    if ($check) {
                        ...
                        header('Location: index0.html'); // Use proper capitalization and ensure no output before this
                        ...
                        <form method="post" action="" id="CustomerLoginForm"  accept-charset="UTF-8" class="contact-form">	
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" required placeholder="enter your email address" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <p class="mb-4">
                                        <a href="forget.php" id="RecoverPassword">Forgot your password?</a> &nbsp; | &nbsp;
