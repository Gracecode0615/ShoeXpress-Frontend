    ...
    <body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                        ...
                        <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                            ...
                            <li class="lvl1 parent megamenu"><a href="#">Men & W <i class="anm anm-angle-down-l"></i></a>
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo.svg" alt="ShoeXpress Logo" />
                            </a>
                        </div>
                    </div>
                                ...
                                <ul class="mini-products-list">
                                    <li class="item">
                                        <a class="product-image" href="#">
                                            <img src="images/" alt="3/4 Sleeve Kimono Dress" title="" />
                                        </a>
                                        <div class="product-details">
                                            <a href="#" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
                                            <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>
                                            <a class="pName" href="cart.html">Sneaker</a>
                                            <div class="variant-cart">Black / 40</div>
        ...
        <table class="table condensed table-bordered table-striped table-hover">
            <h3 class="text-center text-success mt-5" style="margin-top:20px;">Welcome to the Admin page</h3>
            ...
            <tbody>
                <?php while($row = mysqli_fetch_assoc($query)):?>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-danger!important" href="delete.php?id=
