...
<head>
    ...
    <title>Checkout- ShoeXpress</title>
                                        ...
                                        <li class="grid__item large-up--one-whole">
                                            <ul class="grid">
                                                <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">Trending</a>
                                                    <ul class="subLinks">
                                                      <li class="lvl-2"><a href="index0.html" class="site-nav lvl-2">Home 1 - ShoeXpress Extra</a></li>
                                                ...
                                                <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">New & Featured</a>
                                                    <ul class="subLinks">
                                    ...
                                    <ul class="grid grid--uniform mmWrapper">
                                    	<li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">Shoe Pages</a>
                                            <ul class="subLinks">
                                                ...
                                                <li class="lvl-2"><a href="shop-grid-6.html" class="site-nav lvl-2">Sneaker5</a></li>
                        	...
                        	<div class="megamenu style2">
                                <ul class="grid mmWrapper">
                                    <li class="grid__item one-whole">
                                        <ul class="grid">
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">Male & Women Page</a>
                                                <ul class="subLinks">
                        	...
                        	<ul class="mini-products-list">
                                <li class="item">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="variant-cart">Black / 41</div>
                                ...
                                <li class="item">
                                    ...
                                    <div class="product-details">
                                    	<a href="#" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
                                        <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>
                                        <a class="pName" href="cart.html">Sneaker</a>
                                        <div class="variant-cart">Gray /46</div>
                                        <div class="wrapQtyBtn">
                                            <div class="qtyField">
                                            	<span class="label">Qty:</span>
                                                <a class="qtyBtn minus" href="javascript:void(0);"><i class="fa anm anm-minus-r" aria-hidden="true"></i></a>
    ...
    <div class="mobile-nav-wrapper" role="navigation">
        ...
        <ul id="MobileNav" class="mobile-nav">
        	<li class="lvl1 parent megamenu"><a href="index0.html">Home <i class="anm anm-plus-l"></i></a>
          <ul>
            <li><a href="#" class="site-nav">Home Group 1<i class="anm anm-plus-l"></i></a>
              <ul>
                <li><a href="index0.html" class="site-nav">Home 1 - Classic</a></li>
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper mt-5"><h1 class="page-width">Checkout</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
                            ...
                            <div class="table-responsive-sm order-table"> 
                                <table class="bg-white table table-bordered table-hover text-center">
                                    ...
                                    <tfoot class="font-weight-600">
                                        <tr>
                                            <td colspan="4" class="text-right">Sneakers2 </td>
                                            <td>$50.00</td>
                                        </tr>
                                        <tr>
