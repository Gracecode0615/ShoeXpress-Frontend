...
if(isset($_POST['reg'])){
    ...
    if ($password1 !== $password2){
        $error_message = "<div class='alert alert-danger'>Password did not match!</div>";
    }elseif($password1 == "" && $password2 == "" ){
        $error_message = "<div class='alert alert-danger'>Field required!</div>";
    }else{
    $email = $_SESSION['user_name'];
    $passwordh =  password_hash($password1, PASSWORD_DEFAULT);

    $sql = "UPDATE `user` SET `password` = '$passwordh' WHERE `email` = '$email'";
    ...
    if($query){
        ...
        $error_message = "<div class='alert alert-danger'>Password Resetting failed!</div>";
    }
    }
}
?>
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper mt-5"><h1 class="page-width ">Login</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
                          ...
                          <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password1" placeholder="New password" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="">
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="CustomerPassword">Confirm Password</label>
                                    <input type="password" value="" name="password2" placeholder="confirm password" id="CustomerPassword" class="">                        	
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <input type="submit" name="reg" class="btn mb-3 mt-4" value="Sign In">
                                <p class="mb-4">
