...
if (isset($_POST['reg'])){
    ...
    $php_errormsg = '';
	if ($email==""){
        $php_errormsg ="<div class='alert alert-danger'>Field required!</div>".mysqli_error($con);
	}else{
		...
		if ($count==1){
			...
			// echo "<script>alert('email is not register with us');</script>";
            $php_errormsg ="<div class='alert alert-danger'>Invalid email address!</div>".mysqli_error($con);
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper mt-5"><h1 class="page-width ">Proceed to Recover Password</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
                       ...
                       <form method="post" action="" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">	
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" placeholder="enter your registered email address" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="">
                                </div>
                            </div>
                            <!-- <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                          ...
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <input type="submit" name="reg" class="btn mb-3 mt-4" value="Go">
                                <!-- <p class="mb-4">
